...
namespace SC
{
    public partial class Form1 : Form
    {
        ...
        public void LoadInit()
        {
            ...
            SCClient.TerminalStateChange += new TerminalEventHandler(SCClient_StateChange);
        }

        private void SCClient_StateChange(object sender, StationComputerEventArgs args)
        {
            try
            {
